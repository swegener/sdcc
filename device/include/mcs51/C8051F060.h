...
/*  DMA0CN  0xD8 */
SBIT(DMA0DO0,	0xD8);  /* ADC0 Data Overflow Warning Flag               */
SBIT(DMA0DO1,	0xD9);  /* ADC1 Data Overflow Warning Flag               */
SBIT(DMA0DOE,	0xDA);  /* Data Overflow Warning Interrupt Enable        */
SBIT(DMA0DE0,	0xDB);  /* ADC0 Data Overflow Error Flag                 */
SBIT(DMA0DE1,	0xDC);  /* ADC1 Data Overflow Error Flag                 */
SBIT(DMA0MD,	0xDD);  /* DMA0 Mode Select                              */
SBIT(DMA0INT,	0xDE);  /* DMA0 Operations Complete Flag                 */
SBIT(DMA0EN,	0xDF);  /* DMA0 Enable                                   */
...
SBIT(AD1CM2,	0xEB);  /* ADC 1 CONVERT START MODE BIT 1                */
...
/*  ADC2CN  0xE8 */
SBIT(AD2LJST,	0xE8);  /* ADC 2 LEFT JUSTIFY SELECT                     */
...
/*  DMA0CF  0xF8 */
SBIT(DMA0EO,	0xF8);  /* END-OF-OPERATION FLAG                         */
SBIT(DMA0EOE,	0xF9);  /* END-OF-OPERATION INTERRUPT ENABLE             */
SBIT(DMA0CI,	0xFA);  /* REPEAT COUNTER OVERFLOW FLAG                  */
SBIT(DMA0CIE,	0xFB);  /* REPEAT COUNTER OVERFLOW INTERRUPT ENABLE      */
SBIT(DMA0XBY,	0xFE);  /* OFF-CHIP XRAM BUSY FLAG                       */
SBIT(DMA0HLT,	0xFF);  /* HALT DMA0 OFF-CHIP XRAM ACCESS                */
