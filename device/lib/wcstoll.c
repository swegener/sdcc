/*---------------------------------------------------------------------
   wcstoll() - convert a wide string to a long long int and return it
...
long long int wcstoll(const wchar_t *restrict nptr, wchar_t **restrict endptr, int base)
{
  ...
  // wcstoull() would accept leading blanks or signs (that might come after L'-' handled above)
