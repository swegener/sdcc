...
struct dis_entry disass_m6809[]=
  {
   ...
   { 0x20, 0xff, 'b', 1, "BRA %b"	, 0, 0 },
   { 0x21, 0xff, ' ', 1, "BRN %b"	, 0, 0 },
   { 0x22, 0xff, 'b', 1, "BHI %b"	, 0, 0 },
   { 0x23, 0xff, 'b', 1, "BLS %b"	, 0, 0 },
   { 0x24, 0xff, 'b', 1, "BHS %b"	, 0, 0 },
   { 0x25, 0xff, 'b', 1, "BLO %b"	, 0, 0 },
   { 0x26, 0xff, 'b', 1, "BNE %b"	, 0, 0 },
   { 0x27, 0xff, 'b', 1, "BEQ %b"	, 0, 0 },
   { 0x28, 0xff, 'b', 1, "BVC %b"	, 0, 0 },
   { 0x29, 0xff, 'b', 1, "BVS %b"	, 0, 0 },
   { 0x2a, 0xff, 'b', 1, "BPL %b"	, 0, 0 },
   { 0x2b, 0xff, 'b', 1, "BMI %b"	, 0, 0 },
   { 0x2c, 0xff, 'b', 1, "BGE %b"	, 0, 0 },
   { 0x2d, 0xff, 'b', 1, "BLT %b"	, 0, 0 },
   { 0x2e, 0xff, 'b', 1, "BGT %b"	, 0, 0 },
   { 0x2f, 0xff, 'b', 1, "BLE %b"	, 0, 0 },

   { 0x8d, 0xff, 's', 1, "BSR %b"	, 0, 0 },
   { 0xbd, 0xff, 's', 1, "JSR %j"	, 0, 0 },
   { 0x8d, 0xcf, 's', 1, "JSR %b"	, 0, 0 },
   ...
   { 0x39, 0xff, 'x', 1, "RTS"		, 0, 0 },
   { 0x3a, 0xff, ' ', 1, "ABX"		, 0, 0 },
   { 0x3b, 0xff, 'x', 1, "RTI"		, 0, 0 },
   { 0x3d, 0xff, ' ', 1, "MUL"		, 0, 0 },
   { 0x3e, 0xff, 'x', 1, "RESET"	, 0, 0 },
   
   { 0x1c, 0xff, ' ', 1, "ANDCC %i"	, 0, 0 },
   { 0x3c, 0xff, ' ', 1, "CWAI %i"	, 0, 0 },
   { 0x1a, 0xff, ' ', 1, "ORCC %i"	, 0, 0 },

   { 0x0e, 0xff, 'j', 1, "JMP %j"	, 0, 0 },
   { 0x6e, 0xff, ' ', 1, "JMP %j"	, 0, 0 },
   { 0x7e, 0xff, 'j', 1, "JMP %J"	, 0, 0 },
...
struct dis_entry disass_m6809_10[]=
  {
   ...
   { 0x22, 0xff, 'b', 1, "LBHI %E"	, 0, 0 },
   { 0x23, 0xff, 'b', 1, "LBLS %E"	, 0, 0 },
   { 0x24, 0xff, 'b', 1, "LBCC %E"	, 0, 0 },
   { 0x25, 0xff, 'b', 1, "LBCS %E"	, 0, 0 },
   { 0x26, 0xff, 'b', 1, "LBNE %E"	, 0, 0 },
   { 0x27, 0xff, 'b', 1, "LBEQ %E"	, 0, 0 },
   { 0x28, 0xff, 'b', 1, "LBVC %E"	, 0, 0 },
   { 0x29, 0xff, 'b', 1, "LBVS %E"	, 0, 0 },
   { 0x2a, 0xff, 'b', 1, "LBPL %E"	, 0, 0 },
   { 0x2b, 0xff, 'b', 1, "LBMI %E"	, 0, 0 },
   { 0x2c, 0xff, 'b', 1, "LBGE %E"	, 0, 0 },
   { 0x2d, 0xff, 'b', 1, "LBLT %E"	, 0, 0 },
   { 0x2e, 0xff, 'b', 1, "LBGT %E"	, 0, 0 },
   { 0x2f, 0xff, 'b', 1, "LBLE %E"	, 0, 0 },
