...
DEC(0, 30,	pul16	, _cX		, "PULX"	, ' ', 1	, 3)
DEC(0, 31,	pul16	, _cY		, "PULY"	, ' ', 1	, 3)
DEC(0, 32,	pul8	, _cA		, "PULA"	, ' ', 1	, 3)
DEC(0, 33,	pul8	, _cB		, "PULB"	, ' ', 1	, 3)
DEC(0, 34,	psh16	, _Xop		, "PSHX"	, ' ', 1	, 2)
DEC(0, 35,	psh16	, _Yop		, "PSHY"	, ' ', 1	, 2)
DEC(0, 36,	psh8	, _Aop		, "PSHA"	, ' ', 1	, 2)
DEC(0, 37,	psh8	, _Bop		, "PSHB"	, ' ', 1	, 2)
DEC(0, 38,	pul8	, _cC		, "PULC"	, ' ', 1	, 3)
DEC(0, 39,	psh8	, _Cop		, "PSHC"	, ' ', 1	, 2)
DEC(0, 3a,	pul16	, _cD		, "PULD"	, ' ', 1	, 3)
DEC(0, 3b,	psh16	, _Dop		, "PSHD"	, ' ', 1	, 2)
