...
const char * p12cpu_version= "2.1.0";
...
0x0000f025, 0x0600f5da, /* 0600f5da //C 0f025    69 st	r0,reg0 */
0x0000f026, 0x0610f5db, /* 0610f5db //C 0f026    70 st	r1,reg1 */
0x0000f027, 0x0620f5dc, /* 0620f5dc //C 0f027    71 st	r2,reg2 */
0x0000f028, 0x0630f5dd, /* 0630f5dd //C 0f028    72 st	r3,reg3 */
0x0000f029, 0x0640f5de, /* 0640f5de //C 0f029    73 st	r4,reg4 */
0x0000f02a, 0x0650f5df, /* 0650f5df //C 0f02a    74 st	r5,reg5 */
0x0000f02b, 0x0660f5e0, /* 0660f5e0 //C 0f02b    75 st	r6,reg6 */
0x0000f02c, 0x0670f5e1, /* 0670f5e1 //C 0f02c    76 st	r7,reg7 */
0x0000f02d, 0x0680f5e2, /* 0680f5e2 //C 0f02d    77 st	r8,reg8 */
0x0000f02e, 0x0690f5e3, /* 0690f5e3 //C 0f02e    78 st	r9,reg9 */
0x0000f02f, 0x06a0f5e4, /* 06a0f5e4 //C 0f02f    79 st	r10,reg10 */
0x0000f030, 0x06b0f5e5, /* 06b0f5e5 //C 0f030    80 st	r11,reg11 */
0x0000f031, 0x06c0f5e6, /* 06c0f5e6 //C 0f031    81 st	r12,reg12 */
0x0000f032, 0x06d0f5e7, /* 06d0f5e7 //C 0f032    82 st	r13,reg13 */
0x0000f033, 0x06e0f5e8, /* 06e0f5e8 //C 0f033    83 st	r14,reg14 */
0x0000f034, 0x06e0f5e9, /* 06e0f5e9 //C 0f034    84 st	r14,reg15 */
0x0000f035, 0x020e0000, /* 020e0000 //C 0f035    85 getf	r0 */
0x0000f036, 0x0600f5ea, /* 0600f5ea //C 0f036    86 st	r0,regf */
0x0000f037, 0x01020001, /* 01020001 //C 0f037    87 mvzl	r0,1 */
0x0000f038, 0x0600f5d8, /* 0600f5d8 //C 0f038    88 st	r0,called */
...
0x0000f03d, 0x0600f5d8, /* 0600f5d8 //C 0f03d    96 st	r0,called */
...
0x0000f042, 0x0600f5ea, /* 0600f5ea //C 0f042   101 st	r0,regf		; FALGS= 0 */
0x0000f043, 0x0102f7ff, /* 0102f7ff //C 0f043   102 mvzl	r0,0xf7ff	; R13= 0xf7ff */
0x0000f044, 0x0600f5e7, /* 0600f5e7 //C 0f044   103 st	r0,reg13 */
0x0000f045, 0x01f2f046, /* 01f2f046 //C 0f045   104 jmp	common_start: */
0x0000f046, 0x01d2f82a, /* 01d2f82a //C 0f046   107 mvzl	sp,stack_end */
0x0000f047, 0x01020001, /* 01020001 //C 0f047   108 mvzl	r0,1 */
0x0000f048, 0x0600f5d7, /* 0600f5d7 //C 0f048   109 st	r0,echo */
...
0x0000f055, 0x0102f5eb, /* 0102f5eb //C 0f055   130 mvzl	r0,msg_start */
0x0000f056, 0x0400f476, /* 0400f476 //C 0f056   131 call	printsnl */
0x0000f057, 0x0700f5d8, /* 0700f5d8 //C 0f057   133 ld	r0,called */
...
0x0000f05c, 0x0102f5f9, /* 0102f5f9 //C 0f05c   138 mvzl	r0,msg_stopat */
0x0000f05d, 0x0400f453, /* 0400f453 //C 0f05d   139 call	prints */
0x0000f05e, 0x0700f5e8, /* 0700f5e8 //C 0f05e   140 ld	r0,reg14 */
...
0x0000f067, 0x0610f5d0, /* 0610f5d0 //C 0f067   160 st	r1,line_ptr */
0x0000f068, 0x0610f56c, /* 0610f56c //C 0f068   161 st	r1,line		; line[0]= 0 */
0x0000f069, 0x01120000, /* 01120000 //C 0f069   162 mvzl	r1,0		; at_eol= 0 */
0x0000f06a, 0x0610f5d1, /* 0610f5d1 //C 0f06a   163 st	r1,at_eol */
0x0000f06b, 0x0102f607, /* 0102f607 //C 0f06b   165 mvzl	r0,prompt */
...
0x0000f080, 0x0700f5d0, /* 0700f5d0 //C 0f080   204 ld	r0,line_ptr */
...
0x0000f084, 0x0600f5d0, /* 0600f5d0 //C 0f084   208 st	r0,line_ptr */
0x0000f085, 0x0112f56c, /* 0112f56c //C 0f085   209 mvzl	r1,line */
0x0000f086, 0x01220000, /* 01220000 //C 0f086   210 mvzl	r2,0 */
0x0000f087, 0x08210000, /* 08210000 //C 0f087   211 st	r2,r1,r0 */
0x0000f088, 0x0102f603, /* 0102f603 //C 0f088   212 mvzl	r0,msg_BS */
...
0x0000f091, 0x0620f5d1, /* 0620f5d1 //C 0f091   223 st	r2,at_eol */
0x0000f092, 0x0112f5d0, /* 0112f5d0 //C 0f092   224 mvzl	r1,line_ptr	; line[line_ptr]= char */
0x0000f093, 0x0e310000, /* 0e310000 //C 0f093   225 ld	r3,r1 */
0x0000f094, 0x0122f56c, /* 0122f56c //C 0f094   226 mvzl	r2,line */
...
0x0000f09b, 0x0142f5d7, /* 0142f5d7 //C 0f09b   234 mvzl	r4,echo		; check if echo is turned on */
...
0x0000f0a1, 0x0112f5d1, /* 0112f5d1 //C 0f0a1   241 mvzl	r1,at_eol */
...
0x0000f0aa, 0x0700f56c, /* 0700f56c //C 0f0aa   261 ld	r0,line */
...
0x0000f0b5, 0x0610f5d1, /* 0610f5d1 //C 0f0b5   295 st	r1,at_eol */
...
0x0000f0cd, 0x0112f609, /* 0112f609 //C 0f0cd   308 mvzl	r1,delimiters */
...
0x0000f0d1, 0x0142f5d2, /* 0142f5d2 //C 0f0d1   320 mvzl	r4,words	; array of result */
0x0000f0d2, 0x0152f56c, /* 0152f56c //C 0f0d2   321 mvzl	r5,line		; address of next char */
...
0x0000f0f5, 0x0700f5d2, /* 0700f5d2 //C 0f0f5   373 ld	r0,words	; R0= 1st word of command */
...
0x0000f10c, 0x0630f5d9, /* 0630f5d9 //C 0f10c   399 st	r3,nuof_reg */
0x0000f10d, 0x01f2f110, /* 01f2f110 //C 0f10d   400 jmp	find_rx */
0x0000f10e, 0x01260030, /* 01260030 //C 0f10e   402 sub	r2,'0' */
0x0000f10f, 0x0620f5d9, /* 0620f5d9 //C 0f10f   403 st	r2,nuof_reg */
...
0x0000f113, 0x01a2f625, /* 01a2f625 //C 0f113   410 mvzl	r10,commands */
...
0x0000f138, 0x0122f5d2, /* 0122f5d2 //C 0f138   456 mvzl	r2,words */
...
0x0000f14a, 0x0132f82b, /* 0132f82b //C 0f14a   478 mvzl	r3,the_end */
...
0x0000f191, 0x0122f5d2, /* 0122f5d2 //C 0f191   525 mvzl	r2,words */
...
0x0000f1a3, 0x0132f82b, /* 0132f82b //C 0f1a3   547 mvzl	r3,the_end */
...
0x0000f1b4, 0x0122f5d2, /* 0122f5d2 //C 0f1b4   574 mvzl	r2,words */
...
0x0000f25d, 0x0122f5d2, /* 0122f5d2 //C 0f25d   796 mvzl	r2,words */
...
0x0000f26a, 0x06b0f5e9, /* 06b0f5e9 //C 0f26a   810 st	r11,reg15 */
...
0x0000f270, 0x0600f5d8, /* 0600f5d8 //C 0f270   819 st	r0,called */
0x0000f271, 0x0700f5ea, /* 0700f5ea //C 0f271   821 ld	r0,regf */
0x0000f272, 0x020f0000, /* 020f0000 //C 0f272   822 setf	r0 */
0x0000f273, 0x0700f5da, /* 0700f5da //C 0f273   823 ld	r0,reg0 */
0x0000f274, 0x0710f5db, /* 0710f5db //C 0f274   824 ld	r1,reg1 */
0x0000f275, 0x0720f5dc, /* 0720f5dc //C 0f275   825 ld	r2,reg2 */
0x0000f276, 0x0730f5dd, /* 0730f5dd //C 0f276   826 ld	r3,reg3 */
0x0000f277, 0x0740f5de, /* 0740f5de //C 0f277   827 ld	r4,reg4 */
0x0000f278, 0x0750f5df, /* 0750f5df //C 0f278   828 ld	r5,reg5 */
0x0000f279, 0x0760f5e0, /* 0760f5e0 //C 0f279   829 ld	r6,reg6 */
0x0000f27a, 0x0770f5e1, /* 0770f5e1 //C 0f27a   830 ld	r7,reg7 */
0x0000f27b, 0x0780f5e2, /* 0780f5e2 //C 0f27b   831 ld	r8,reg8 */
0x0000f27c, 0x0790f5e3, /* 0790f5e3 //C 0f27c   832 ld	r9,reg9 */
0x0000f27d, 0x07a0f5e4, /* 07a0f5e4 //C 0f27d   833 ld	r10,reg10 */
0x0000f27e, 0x07b0f5e5, /* 07b0f5e5 //C 0f27e   834 ld	r11,reg11 */
0x0000f27f, 0x07c0f5e6, /* 07c0f5e6 //C 0f27f   835 ld	r12,reg12 */
0x0000f280, 0x07d0f5e7, /* 07d0f5e7 //C 0f280   836 ld	r13,reg13 */
0x0000f281, 0x07e0f5e8, /* 07e0f5e8 //C 0f281   837 ld	r14,reg14 */
0x0000f282, 0x07f0f5e9, /* 07f0f5e9 //C 0f282   839 ld	r15,reg15 */
0x0000f283, 0x0700f5d8, /* 0700f5d8 //C 0f283   842 ld	r0,called */
0x0000f284, 0x020b0000, /* 020b0000 //C 0f284   843 sz	r0 */
0x0000f285, 0x11f2f288, /* 11f2f288 //C 0f285   844 jz	g_err */
0x0000f286, 0x07b0f5e9, /* 07b0f5e9 //C 0f286   845 ld	r11,reg15 */
...
0x0000f29c, 0x0122f67a, /* 0122f67a //C 0f29c   860 mvzl	r2,helps */
...
0x0000f2e5, 0x0112f5da, /* 0112f5da //C 0f2e5   946 mvzl	r1,reg0 */
...
0x0000f303, 0x0700f5d8, /* 0700f5d8 //C 0f303   994 ld	r0,called */
...
0x0000f308, 0x0700f5e9, /* 0700f5e9 //C 0f308  1000 ld	r0,reg15 */
...
0x0000f315, 0x0710f5ea, /* 0710f5ea //C 0f315  1017 ld	r1,regf */
...
0x0000f35e, 0x07a0f5d9, /* 07a0f5d9 //C 0f35e  1047 ld	r10,nuof_reg	; Reg num is in R10 */
...
0x0000f375, 0x0122f5d2, /* 0122f5d2 //C 0f375  1056 mvzl	r2,words */
...
0x0000f38e, 0x0102f5da, /* 0102f5da //C 0f38e  1072 mvzl	r0,reg0 */
...
0x0000f45a, 0x1102f612, /* 1102f612 //C 0f45a  1458 Z1 mvzl	r0,null_str */
...
0x0000f503, 0x0610f5db, /* 0610f5db //C 0f503  1692 st	r1,reg1 */
0x0000f504, 0x0620f5dc, /* 0620f5dc //C 0f504  1693 st	r2,reg2 */
0x0000f505, 0x0630f5dd, /* 0630f5dd //C 0f505  1694 st	r3,reg3 */
0x0000f506, 0x0640f5de, /* 0640f5de //C 0f506  1695 st	r4,reg4 */
0x0000f507, 0x0650f5df, /* 0650f5df //C 0f507  1696 st	r5,reg5 */
0x0000f508, 0x0660f5e0, /* 0660f5e0 //C 0f508  1697 st	r6,reg6 */
0x0000f509, 0x0670f5e1, /* 0670f5e1 //C 0f509  1698 st	r7,reg7 */
0x0000f50a, 0x0680f5e2, /* 0680f5e2 //C 0f50a  1699 st	r8,reg8 */
0x0000f50b, 0x0690f5e3, /* 0690f5e3 //C 0f50b  1700 st	r9,reg9 */
0x0000f50c, 0x06a0f5e4, /* 06a0f5e4 //C 0f50c  1701 st	r10,reg10 */
0x0000f50d, 0x06b0f5e5, /* 06b0f5e5 //C 0f50d  1702 st	r11,reg11 */
0x0000f50e, 0x06c0f5e6, /* 06c0f5e6 //C 0f50e  1703 st	r12,reg12 */
0x0000f50f, 0x00200000, /* 00200000 //C 0f50f  1705 mov	r2,r0		; pointer to format string */
0x0000f510, 0x0112f5db, /* 0112f5db //C 0f510  1706 mvzl	r1,reg1		; pointer to params */
...
0x0000f568, 0x0620f5dc, /* 0620f5dc //C 0f568  1822 st	r2,reg2 */
0x0000f569, 0x0f2d0000, /* 0f2d0000 //C 0f569  1823 pop	r2 */
0x0000f56a, 0x0f0d0000, /* 0f0d0000 //C 0f56a  1824 pop	r0 */
0x0000f56b, 0x07f0f5dc, /* 07f0f5dc //C 0f56b  1825 ld	PC,reg2 */
0x0000f56c, 0x00000000, /* 00000000 //C 0f56c  1830 line:		ds	100		; line buffer */
0x0000f5d0, 0x00000000, /* 00000000 //C 0f5d0  1831 line_ptr:	ds	1		; line pointer (index) */
0x0000f5d1, 0x00000000, /* 00000000 //C 0f5d1  1832 at_eol:		ds	1		; bool, true if EOL arrived */
0x0000f5d2, 0x00000000, /* 00000000 //C 0f5d2  1833 words:		ds	5		; Tokens of line */
0x0000f5d7, 0x00000000, /* 00000000 //C 0f5d7  1834 echo:		ds	1		; bool, do echo or not */
0x0000f5d8, 0x00000000, /* 00000000 //C 0f5d8  1835 dd	0 */
0x0000f5d9, 0x00000000, /* 00000000 //C 0f5d9  1836 dd	0 */
0x0000f5da, 0x00000000, /* 00000000 //C 0f5da  1838 dd	0 */
...
0x0000f5eb, 0x00000050, /* 00000050 //C 0f5eb  1856 db	80 */
0x0000f5ec, 0x0000004d, /* 0000004d //C 0f5ec  1856 db	77 */
0x0000f5ed, 0x0000006f, /* 0000006f //C 0f5ed  1856 db	111 */
0x0000f5ee, 0x0000006e, /* 0000006e //C 0f5ee  1856 db	110 */
0x0000f5ef, 0x00000069, /* 00000069 //C 0f5ef  1856 db	105 */
0x0000f5f0, 0x00000074, /* 00000074 //C 0f5f0  1856 db	116 */
0x0000f5f1, 0x0000006f, /* 0000006f //C 0f5f1  1856 db	111 */
0x0000f5f2, 0x00000072, /* 00000072 //C 0f5f2  1856 db	114 */
0x0000f5f3, 0x00000020, /* 00000020 //C 0f5f3  1856 db	32 */
0x0000f5f4, 0x00000076, /* 00000076 //C 0f5f4  1856 db	118 */
0x0000f5f5, 0x00000031, /* 00000031 //C 0f5f5  1856 db	49 */
0x0000f5f6, 0x0000002e, /* 0000002e //C 0f5f6  1856 db	46 */
0x0000f5f7, 0x00000030, /* 00000030 //C 0f5f7  1856 db	48 */
0x0000f5f8, 0x00000000, /* 00000000 //C 0f5f8  1856 db */
0x0000f5f9, 0x00000053, /* 00000053 //C 0f5f9  1857 db	83 */
0x0000f5fa, 0x00000074, /* 00000074 //C 0f5fa  1857 db	116 */
0x0000f5fb, 0x0000006f, /* 0000006f //C 0f5fb  1857 db	111 */
0x0000f5fc, 0x00000070, /* 00000070 //C 0f5fc  1857 db	112 */
0x0000f5fd, 0x00000020, /* 00000020 //C 0f5fd  1857 db	32 */
0x0000f5fe, 0x00000061, /* 00000061 //C 0f5fe  1857 db	97 */
0x0000f5ff, 0x00000074, /* 00000074 //C 0f5ff  1857 db	116 */
0x0000f600, 0x0000003a, /* 0000003a //C 0f600  1857 db	58 */
0x0000f601, 0x00000020, /* 00000020 //C 0f601  1857 db	32 */
0x0000f602, 0x00000000, /* 00000000 //C 0f602  1857 db */
0x0000f603, 0x00000008, /* 00000008 //C 0f603  1858 db	8 */
0x0000f604, 0x00000020, /* 00000020 //C 0f604  1858 db	32 */
0x0000f605, 0x00000008, /* 00000008 //C 0f605  1858 db	8 */
0x0000f606, 0x00000000, /* 00000000 //C 0f606  1858 db	0 */
0x0000f607, 0x0000003a, /* 0000003a //C 0f607  1859 db	58 */
0x0000f608, 0x00000000, /* 00000000 //C 0f608  1859 db */
0x0000f609, 0x00000020, /* 00000020 //C 0f609  1860 db	32 */
0x0000f60a, 0x0000003b, /* 0000003b //C 0f60a  1860 db	59 */
0x0000f60b, 0x00000009, /* 00000009 //C 0f60b  1860 db	9 */
0x0000f60c, 0x0000000b, /* 0000000b //C 0f60c  1860 db	11 */
0x0000f60d, 0x0000002c, /* 0000002c //C 0f60d  1860 db	44 */
0x0000f60e, 0x0000003d, /* 0000003d //C 0f60e  1860 db	61 */
0x0000f60f, 0x0000005b, /* 0000005b //C 0f60f  1860 db	91 */
0x0000f610, 0x0000005d, /* 0000005d //C 0f610  1860 db	93 */
0x0000f611, 0x00000000, /* 00000000 //C 0f611  1860 db */
0x0000f612, 0x00000028, /* 00000028 //C 0f612  1861 db	40 */
0x0000f613, 0x0000006e, /* 0000006e //C 0f613  1861 db	110 */
0x0000f614, 0x00000075, /* 00000075 //C 0f614  1861 db	117 */
0x0000f615, 0x0000006c, /* 0000006c //C 0f615  1861 db	108 */
0x0000f616, 0x0000006c, /* 0000006c //C 0f616  1861 db	108 */
0x0000f617, 0x00000029, /* 00000029 //C 0f617  1861 db	41 */
0x0000f618, 0x00000000, /* 00000000 //C 0f618  1861 db */
0x0000f619, 0x00000000, /* 00000000 //C 0f619  1862 db	0 */
0x0000f61a, 0x00000000, /* 00000000 //C 0f61a  1863 db	0 */
0x0000f61b, 0x00000000, /* 00000000 //C 0f61b  1864 sc_buffer:	ds	10 */
0x0000f625, 0x0000f190, /* 0000f190 //C 0f625  1868 dd	cmd_sm */
0x0000f626, 0x00000073, /* 00000073 //C 0f626  1869 db	115 */
0x0000f627, 0x0000006d, /* 0000006d //C 0f627  1869 db	109 */
0x0000f628, 0x00000000, /* 00000000 //C 0f628  1869 db */
0x0000f629, 0x0000f137, /* 0000f137 //C 0f629  1870 dd	cmd_m */
0x0000f62a, 0x0000006d, /* 0000006d //C 0f62a  1871 db	109 */
0x0000f62b, 0x00000000, /* 00000000 //C 0f62b  1871 db */
0x0000f62c, 0x0000f137, /* 0000f137 //C 0f62c  1872 dd	cmd_m */
0x0000f62d, 0x0000006d, /* 0000006d //C 0f62d  1873 db	109 */
0x0000f62e, 0x00000065, /* 00000065 //C 0f62e  1873 db	101 */
0x0000f62f, 0x0000006d, /* 0000006d //C 0f62f  1873 db	109 */
0x0000f630, 0x00000000, /* 00000000 //C 0f630  1873 db */
0x0000f631, 0x0000f1b3, /* 0000f1b3 //C 0f631  1874 dd	cmd_d */
0x0000f632, 0x00000064, /* 00000064 //C 0f632  1875 db	100 */
0x0000f633, 0x00000000, /* 00000000 //C 0f633  1875 db */
0x0000f634, 0x0000f1b3, /* 0000f1b3 //C 0f634  1876 dd	cmd_d */
0x0000f635, 0x00000064, /* 00000064 //C 0f635  1877 db	100 */
0x0000f636, 0x00000075, /* 00000075 //C 0f636  1877 db	117 */
0x0000f637, 0x0000006d, /* 0000006d //C 0f637  1877 db	109 */
0x0000f638, 0x00000070, /* 00000070 //C 0f638  1877 db	112 */
0x0000f639, 0x00000000, /* 00000000 //C 0f639  1877 db */
0x0000f63a, 0x0000f1e6, /* 0000f1e6 //C 0f63a  1878 dd	cmd_l */
0x0000f63b, 0x0000006c, /* 0000006c //C 0f63b  1879 db	108 */
0x0000f63c, 0x00000000, /* 00000000 //C 0f63c  1879 db */
0x0000f63d, 0x0000f1e6, /* 0000f1e6 //C 0f63d  1880 dd	cmd_l */
0x0000f63e, 0x0000006c, /* 0000006c //C 0f63e  1881 db	108 */
0x0000f63f, 0x0000006f, /* 0000006f //C 0f63f  1881 db	111 */
0x0000f640, 0x00000061, /* 00000061 //C 0f640  1881 db	97 */
0x0000f641, 0x00000064, /* 00000064 //C 0f641  1881 db	100 */
0x0000f642, 0x00000000, /* 00000000 //C 0f642  1881 db */
0x0000f643, 0x0000f25c, /* 0000f25c //C 0f643  1882 dd	cmd_g */
0x0000f644, 0x00000067, /* 00000067 //C 0f644  1883 db	103 */
0x0000f645, 0x00000000, /* 00000000 //C 0f645  1883 db */
0x0000f646, 0x0000f25c, /* 0000f25c //C 0f646  1884 dd	cmd_g */
0x0000f647, 0x00000067, /* 00000067 //C 0f647  1885 db	103 */
0x0000f648, 0x0000006f, /* 0000006f //C 0f648  1885 db	111 */
0x0000f649, 0x00000000, /* 00000000 //C 0f649  1885 db */
0x0000f64a, 0x0000f25c, /* 0000f25c //C 0f64a  1886 dd	cmd_g */
0x0000f64b, 0x00000072, /* 00000072 //C 0f64b  1887 db	114 */
0x0000f64c, 0x00000075, /* 00000075 //C 0f64c  1887 db	117 */
0x0000f64d, 0x0000006e, /* 0000006e //C 0f64d  1887 db	110 */
0x0000f64e, 0x00000000, /* 00000000 //C 0f64e  1887 db */
0x0000f64f, 0x0000f29b, /* 0000f29b //C 0f64f  1888 dd	cmd_h */
0x0000f650, 0x0000003f, /* 0000003f //C 0f650  1889 db	63 */
0x0000f651, 0x00000000, /* 00000000 //C 0f651  1889 db */
0x0000f652, 0x0000f29b, /* 0000f29b //C 0f652  1890 dd	cmd_h */
0x0000f653, 0x00000068, /* 00000068 //C 0f653  1891 db	104 */
0x0000f654, 0x00000000, /* 00000000 //C 0f654  1891 db */
0x0000f655, 0x0000f29b, /* 0000f29b //C 0f655  1892 dd	cmd_h */
0x0000f656, 0x00000068, /* 00000068 //C 0f656  1893 db	104 */
0x0000f657, 0x00000065, /* 00000065 //C 0f657  1893 db	101 */
0x0000f658, 0x0000006c, /* 0000006c //C 0f658  1893 db	108 */
0x0000f659, 0x00000070, /* 00000070 //C 0f659  1893 db	112 */
0x0000f65a, 0x00000000, /* 00000000 //C 0f65a  1893 db */
0x0000f65b, 0x0000f302, /* 0000f302 //C 0f65b  1894 dd	cmd_r */
0x0000f65c, 0x00000072, /* 00000072 //C 0f65c  1895 db	114 */
0x0000f65d, 0x00000000, /* 00000000 //C 0f65d  1895 db */
0x0000f65e, 0x0000f302, /* 0000f302 //C 0f65e  1896 dd	cmd_r */
0x0000f65f, 0x00000072, /* 00000072 //C 0f65f  1897 db	114 */
0x0000f660, 0x00000065, /* 00000065 //C 0f660  1897 db	101 */
0x0000f661, 0x00000067, /* 00000067 //C 0f661  1897 db	103 */
0x0000f662, 0x00000000, /* 00000000 //C 0f662  1897 db */
0x0000f663, 0x0000f302, /* 0000f302 //C 0f663  1898 dd	cmd_r */
0x0000f664, 0x00000072, /* 00000072 //C 0f664  1899 db	114 */
0x0000f665, 0x00000065, /* 00000065 //C 0f665  1899 db	101 */
0x0000f666, 0x00000067, /* 00000067 //C 0f666  1899 db	103 */
0x0000f667, 0x00000073, /* 00000073 //C 0f667  1899 db	115 */
0x0000f668, 0x00000000, /* 00000000 //C 0f668  1899 db */
0x0000f669, 0x0000f392, /* 0000f392 //C 0f669  1900 dd	cmd_sp */
0x0000f66a, 0x00000073, /* 00000073 //C 0f66a  1901 db	115 */
0x0000f66b, 0x00000070, /* 00000070 //C 0f66b  1901 db	112 */
0x0000f66c, 0x00000000, /* 00000000 //C 0f66c  1901 db */
0x0000f66d, 0x0000f395, /* 0000f395 //C 0f66d  1902 dd	cmd_lr */
0x0000f66e, 0x0000006c, /* 0000006c //C 0f66e  1903 db	108 */
0x0000f66f, 0x00000072, /* 00000072 //C 0f66f  1903 db	114 */
0x0000f670, 0x00000000, /* 00000000 //C 0f670  1903 db */
0x0000f671, 0x0000f398, /* 0000f398 //C 0f671  1904 dd	cmd_pc */
0x0000f672, 0x00000070, /* 00000070 //C 0f672  1905 db	112 */
0x0000f673, 0x00000063, /* 00000063 //C 0f673  1905 db	99 */
0x0000f674, 0x00000000, /* 00000000 //C 0f674  1905 db */
0x0000f675, 0x0000f39b, /* 0000f39b //C 0f675  1906 dd	cmd_f */
0x0000f676, 0x00000066, /* 00000066 //C 0f676  1907 db	102 */
0x0000f677, 0x00000000, /* 00000000 //C 0f677  1907 db */
0x0000f678, 0x00000000, /* 00000000 //C 0f678  1908 dd	0 */
0x0000f679, 0x00000000, /* 00000000 //C 0f679  1909 dd	0 */
0x0000f67a, 0x0000006d, /* 0000006d //C 0f67a  1911 db	109 */
0x0000f67b, 0x0000005b, /* 0000005b //C 0f67b  1911 db	91 */
0x0000f67c, 0x00000065, /* 00000065 //C 0f67c  1911 db	101 */
0x0000f67d, 0x0000006d, /* 0000006d //C 0f67d  1911 db	109 */
0x0000f67e, 0x0000005d, /* 0000005d //C 0f67e  1911 db	93 */
0x0000f67f, 0x00000020, /* 00000020 //C 0f67f  1911 db	32 */
0x0000f680, 0x00000061, /* 00000061 //C 0f680  1911 db	97 */
0x0000f681, 0x00000064, /* 00000064 //C 0f681  1911 db	100 */
0x0000f682, 0x00000064, /* 00000064 //C 0f682  1911 db	100 */
0x0000f683, 0x00000072, /* 00000072 //C 0f683  1911 db	114 */
0x0000f684, 0x00000020, /* 00000020 //C 0f684  1911 db	32 */
0x0000f685, 0x0000005b, /* 0000005b //C 0f685  1911 db	91 */
0x0000f686, 0x00000076, /* 00000076 //C 0f686  1911 db	118 */
0x0000f687, 0x00000061, /* 00000061 //C 0f687  1911 db	97 */
0x0000f688, 0x0000006c, /* 0000006c //C 0f688  1911 db	108 */
0x0000f689, 0x0000005d, /* 0000005d //C 0f689  1911 db	93 */
0x0000f68a, 0x00000020, /* 00000020 //C 0f68a  1911 db	32 */
0x0000f68b, 0x00000020, /* 00000020 //C 0f68b  1911 db	32 */
0x0000f68c, 0x00000047, /* 00000047 //C 0f68c  1911 db	71 */
0x0000f68d, 0x00000065, /* 00000065 //C 0f68d  1911 db	101 */
0x0000f68e, 0x00000074, /* 00000074 //C 0f68e  1911 db	116 */
0x0000f68f, 0x0000002f, /* 0000002f //C 0f68f  1911 db	47 */
0x0000f690, 0x00000073, /* 00000073 //C 0f690  1911 db	115 */
0x0000f691, 0x00000065, /* 00000065 //C 0f691  1911 db	101 */
0x0000f692, 0x00000074, /* 00000074 //C 0f692  1911 db	116 */
0x0000f693, 0x00000020, /* 00000020 //C 0f693  1911 db	32 */
0x0000f694, 0x0000006d, /* 0000006d //C 0f694  1911 db	109 */
0x0000f695, 0x00000065, /* 00000065 //C 0f695  1911 db	101 */
0x0000f696, 0x0000006d, /* 0000006d //C 0f696  1911 db	109 */
0x0000f697, 0x0000006f, /* 0000006f //C 0f697  1911 db	111 */
0x0000f698, 0x00000072, /* 00000072 //C 0f698  1911 db	114 */
0x0000f699, 0x00000079, /* 00000079 //C 0f699  1911 db	121 */
0x0000f69a, 0x0000000a, /* 0000000a //C 0f69a  1911 db	10 */
0x0000f69b, 0x00000000, /* 00000000 //C 0f69b  1911 db */
0x0000f69c, 0x00000064, /* 00000064 //C 0f69c  1912 db	100 */
0x0000f69d, 0x0000005b, /* 0000005b //C 0f69d  1912 db	91 */
0x0000f69e, 0x00000075, /* 00000075 //C 0f69e  1912 db	117 */
0x0000f69f, 0x0000006d, /* 0000006d //C 0f69f  1912 db	109 */
0x0000f6a0, 0x00000070, /* 00000070 //C 0f6a0  1912 db	112 */
0x0000f6a1, 0x0000005d, /* 0000005d //C 0f6a1  1912 db	93 */
0x0000f6a2, 0x00000020, /* 00000020 //C 0f6a2  1912 db	32 */
0x0000f6a3, 0x00000073, /* 00000073 //C 0f6a3  1912 db	115 */
0x0000f6a4, 0x00000074, /* 00000074 //C 0f6a4  1912 db	116 */
0x0000f6a5, 0x00000061, /* 00000061 //C 0f6a5  1912 db	97 */
0x0000f6a6, 0x00000072, /* 00000072 //C 0f6a6  1912 db	114 */
0x0000f6a7, 0x00000074, /* 00000074 //C 0f6a7  1912 db	116 */
0x0000f6a8, 0x00000020, /* 00000020 //C 0f6a8  1912 db	32 */
0x0000f6a9, 0x00000065, /* 00000065 //C 0f6a9  1912 db	101 */
0x0000f6aa, 0x0000006e, /* 0000006e //C 0f6aa  1912 db	110 */
0x0000f6ab, 0x00000064, /* 00000064 //C 0f6ab  1912 db	100 */
0x0000f6ac, 0x00000020, /* 00000020 //C 0f6ac  1912 db	32 */
0x0000f6ad, 0x00000020, /* 00000020 //C 0f6ad  1912 db	32 */
0x0000f6ae, 0x00000044, /* 00000044 //C 0f6ae  1912 db	68 */
0x0000f6af, 0x00000075, /* 00000075 //C 0f6af  1912 db	117 */
0x0000f6b0, 0x0000006d, /* 0000006d //C 0f6b0  1912 db	109 */
0x0000f6b1, 0x00000070, /* 00000070 //C 0f6b1  1912 db	112 */
0x0000f6b2, 0x00000020, /* 00000020 //C 0f6b2  1912 db	32 */
0x0000f6b3, 0x0000006d, /* 0000006d //C 0f6b3  1912 db	109 */
0x0000f6b4, 0x00000065, /* 00000065 //C 0f6b4  1912 db	101 */
0x0000f6b5, 0x0000006d, /* 0000006d //C 0f6b5  1912 db	109 */
0x0000f6b6, 0x0000006f, /* 0000006f //C 0f6b6  1912 db	111 */
0x0000f6b7, 0x00000072, /* 00000072 //C 0f6b7  1912 db	114 */
0x0000f6b8, 0x00000079, /* 00000079 //C 0f6b8  1912 db	121 */
0x0000f6b9, 0x00000020, /* 00000020 //C 0f6b9  1912 db	32 */
0x0000f6ba, 0x00000063, /* 00000063 //C 0f6ba  1912 db	99 */
0x0000f6bb, 0x0000006f, /* 0000006f //C 0f6bb  1912 db	111 */
0x0000f6bc, 0x0000006e, /* 0000006e //C 0f6bc  1912 db	110 */
0x0000f6bd, 0x00000074, /* 00000074 //C 0f6bd  1912 db	116 */
0x0000f6be, 0x00000065, /* 00000065 //C 0f6be  1912 db	101 */
0x0000f6bf, 0x0000006e, /* 0000006e //C 0f6bf  1912 db	110 */
0x0000f6c0, 0x00000074, /* 00000074 //C 0f6c0  1912 db	116 */
0x0000f6c1, 0x0000000a, /* 0000000a //C 0f6c1  1912 db	10 */
0x0000f6c2, 0x00000000, /* 00000000 //C 0f6c2  1912 db */
0x0000f6c3, 0x0000006c, /* 0000006c //C 0f6c3  1913 db	108 */
0x0000f6c4, 0x0000005b, /* 0000005b //C 0f6c4  1913 db	91 */
0x0000f6c5, 0x0000006f, /* 0000006f //C 0f6c5  1913 db	111 */
0x0000f6c6, 0x00000061, /* 00000061 //C 0f6c6  1913 db	97 */
0x0000f6c7, 0x00000064, /* 00000064 //C 0f6c7  1913 db	100 */
0x0000f6c8, 0x0000005d, /* 0000005d //C 0f6c8  1913 db	93 */
0x0000f6c9, 0x00000020, /* 00000020 //C 0f6c9  1913 db	32 */
0x0000f6ca, 0x00000020, /* 00000020 //C 0f6ca  1913 db	32 */
0x0000f6cb, 0x00000020, /* 00000020 //C 0f6cb  1913 db	32 */
0x0000f6cc, 0x00000020, /* 00000020 //C 0f6cc  1913 db	32 */
0x0000f6cd, 0x00000020, /* 00000020 //C 0f6cd  1913 db	32 */
0x0000f6ce, 0x00000020, /* 00000020 //C 0f6ce  1913 db	32 */
0x0000f6cf, 0x00000020, /* 00000020 //C 0f6cf  1913 db	32 */
0x0000f6d0, 0x00000020, /* 00000020 //C 0f6d0  1913 db	32 */
0x0000f6d1, 0x00000020, /* 00000020 //C 0f6d1  1913 db	32 */
0x0000f6d2, 0x00000020, /* 00000020 //C 0f6d2  1913 db	32 */
0x0000f6d3, 0x00000020, /* 00000020 //C 0f6d3  1913 db	32 */
0x0000f6d4, 0x00000020, /* 00000020 //C 0f6d4  1913 db	32 */
0x0000f6d5, 0x0000004c, /* 0000004c //C 0f6d5  1913 db	76 */
0x0000f6d6, 0x0000006f, /* 0000006f //C 0f6d6  1913 db	111 */
0x0000f6d7, 0x00000061, /* 00000061 //C 0f6d7  1913 db	97 */
0x0000f6d8, 0x00000064, /* 00000064 //C 0f6d8  1913 db	100 */
0x0000f6d9, 0x00000020, /* 00000020 //C 0f6d9  1913 db	32 */
0x0000f6da, 0x00000068, /* 00000068 //C 0f6da  1913 db	104 */
0x0000f6db, 0x00000065, /* 00000065 //C 0f6db  1913 db	101 */
0x0000f6dc, 0x00000078, /* 00000078 //C 0f6dc  1913 db	120 */
0x0000f6dd, 0x00000020, /* 00000020 //C 0f6dd  1913 db	32 */
0x0000f6de, 0x00000066, /* 00000066 //C 0f6de  1913 db	102 */
0x0000f6df, 0x00000069, /* 00000069 //C 0f6df  1913 db	105 */
0x0000f6e0, 0x0000006c, /* 0000006c //C 0f6e0  1913 db	108 */
0x0000f6e1, 0x00000065, /* 00000065 //C 0f6e1  1913 db	101 */
0x0000f6e2, 0x00000020, /* 00000020 //C 0f6e2  1913 db	32 */
0x0000f6e3, 0x00000074, /* 00000074 //C 0f6e3  1913 db	116 */
0x0000f6e4, 0x0000006f, /* 0000006f //C 0f6e4  1913 db	111 */
0x0000f6e5, 0x00000020, /* 00000020 //C 0f6e5  1913 db	32 */
0x0000f6e6, 0x0000006d, /* 0000006d //C 0f6e6  1913 db	109 */
0x0000f6e7, 0x00000065, /* 00000065 //C 0f6e7  1913 db	101 */
0x0000f6e8, 0x0000006d, /* 0000006d //C 0f6e8  1913 db	109 */
0x0000f6e9, 0x0000006f, /* 0000006f //C 0f6e9  1913 db	111 */
0x0000f6ea, 0x00000072, /* 00000072 //C 0f6ea  1913 db	114 */
0x0000f6eb, 0x00000079, /* 00000079 //C 0f6eb  1913 db	121 */
0x0000f6ec, 0x0000000a, /* 0000000a //C 0f6ec  1913 db	10 */
0x0000f6ed, 0x00000000, /* 00000000 //C 0f6ed  1913 db */
0x0000f6ee, 0x00000067, /* 00000067 //C 0f6ee  1914 db	103 */
0x0000f6ef, 0x0000005b, /* 0000005b //C 0f6ef  1914 db	91 */
0x0000f6f0, 0x0000006f, /* 0000006f //C 0f6f0  1914 db	111 */
0x0000f6f1, 0x0000005d, /* 0000005d //C 0f6f1  1914 db	93 */
0x0000f6f2, 0x0000007c, /* 0000007c //C 0f6f2  1914 db	124 */
0x0000f6f3, 0x00000072, /* 00000072 //C 0f6f3  1914 db	114 */
0x0000f6f4, 0x00000075, /* 00000075 //C 0f6f4  1914 db	117 */
0x0000f6f5, 0x0000006e, /* 0000006e //C 0f6f5  1914 db	110 */
0x0000f6f6, 0x00000020, /* 00000020 //C 0f6f6  1914 db	32 */
0x0000f6f7, 0x0000005b, /* 0000005b //C 0f6f7  1914 db	91 */
0x0000f6f8, 0x00000061, /* 00000061 //C 0f6f8  1914 db	97 */
0x0000f6f9, 0x00000064, /* 00000064 //C 0f6f9  1914 db	100 */
0x0000f6fa, 0x00000064, /* 00000064 //C 0f6fa  1914 db	100 */
0x0000f6fb, 0x00000072, /* 00000072 //C 0f6fb  1914 db	114 */
0x0000f6fc, 0x0000005d, /* 0000005d //C 0f6fc  1914 db	93 */
0x0000f6fd, 0x00000020, /* 00000020 //C 0f6fd  1914 db	32 */
0x0000f6fe, 0x00000020, /* 00000020 //C 0f6fe  1914 db	32 */
0x0000f6ff, 0x00000020, /* 00000020 //C 0f6ff  1914 db	32 */
0x0000f700, 0x00000052, /* 00000052 //C 0f700  1914 db	82 */
0x0000f701, 0x00000075, /* 00000075 //C 0f701  1914 db	117 */
0x0000f702, 0x0000006e, /* 0000006e //C 0f702  1914 db	110 */
0x0000f703, 0x00000020, /* 00000020 //C 0f703  1914 db	32 */
0x0000f704, 0x00000066, /* 00000066 //C 0f704  1914 db	102 */
0x0000f705, 0x00000072, /* 00000072 //C 0f705  1914 db	114 */
0x0000f706, 0x0000006f, /* 0000006f //C 0f706  1914 db	111 */
0x0000f707, 0x0000006d, /* 0000006d //C 0f707  1914 db	109 */
0x0000f708, 0x00000020, /* 00000020 //C 0f708  1914 db	32 */
0x0000f709, 0x00000061, /* 00000061 //C 0f709  1914 db	97 */
0x0000f70a, 0x00000064, /* 00000064 //C 0f70a  1914 db	100 */
0x0000f70b, 0x00000064, /* 00000064 //C 0f70b  1914 db	100 */
0x0000f70c, 0x00000072, /* 00000072 //C 0f70c  1914 db	114 */
0x0000f70d, 0x00000065, /* 00000065 //C 0f70d  1914 db	101 */
0x0000f70e, 0x00000073, /* 00000073 //C 0f70e  1914 db	115 */
0x0000f70f, 0x00000073, /* 00000073 //C 0f70f  1914 db	115 */
0x0000f710, 0x0000000a, /* 0000000a //C 0f710  1914 db	10 */
0x0000f711, 0x00000000, /* 00000000 //C 0f711  1914 db */
0x0000f712, 0x00000072, /* 00000072 //C 0f712  1915 db	114 */
0x0000f713, 0x0000005b, /* 0000005b //C 0f713  1915 db	91 */
0x0000f714, 0x00000065, /* 00000065 //C 0f714  1915 db	101 */
0x0000f715, 0x00000067, /* 00000067 //C 0f715  1915 db	103 */
0x0000f716, 0x0000005b, /* 0000005b //C 0f716  1915 db	91 */
0x0000f717, 0x00000073, /* 00000073 //C 0f717  1915 db	115 */
0x0000f718, 0x0000005d, /* 0000005d //C 0f718  1915 db	93 */
0x0000f719, 0x0000005d, /* 0000005d //C 0f719  1915 db	93 */
0x0000f71a, 0x00000020, /* 00000020 //C 0f71a  1915 db	32 */
0x0000f71b, 0x00000020, /* 00000020 //C 0f71b  1915 db	32 */
0x0000f71c, 0x00000020, /* 00000020 //C 0f71c  1915 db	32 */
0x0000f71d, 0x00000020, /* 00000020 //C 0f71d  1915 db	32 */
0x0000f71e, 0x00000020, /* 00000020 //C 0f71e  1915 db	32 */
0x0000f71f, 0x00000020, /* 00000020 //C 0f71f  1915 db	32 */
0x0000f720, 0x00000020, /* 00000020 //C 0f720  1915 db	32 */
0x0000f721, 0x00000020, /* 00000020 //C 0f721  1915 db	32 */
0x0000f722, 0x00000020, /* 00000020 //C 0f722  1915 db	32 */
0x0000f723, 0x00000020, /* 00000020 //C 0f723  1915 db	32 */
0x0000f724, 0x00000050, /* 00000050 //C 0f724  1915 db	80 */
0x0000f725, 0x00000072, /* 00000072 //C 0f725  1915 db	114 */
0x0000f726, 0x00000069, /* 00000069 //C 0f726  1915 db	105 */
0x0000f727, 0x0000006e, /* 0000006e //C 0f727  1915 db	110 */
0x0000f728, 0x00000074, /* 00000074 //C 0f728  1915 db	116 */
0x0000f729, 0x00000020, /* 00000020 //C 0f729  1915 db	32 */
0x0000f72a, 0x00000072, /* 00000072 //C 0f72a  1915 db	114 */
0x0000f72b, 0x00000065, /* 00000065 //C 0f72b  1915 db	101 */
0x0000f72c, 0x00000067, /* 00000067 //C 0f72c  1915 db	103 */
0x0000f72d, 0x00000069, /* 00000069 //C 0f72d  1915 db	105 */
0x0000f72e, 0x00000073, /* 00000073 //C 0f72e  1915 db	115 */
0x0000f72f, 0x00000074, /* 00000074 //C 0f72f  1915 db	116 */
0x0000f730, 0x00000065, /* 00000065 //C 0f730  1915 db	101 */
0x0000f731, 0x00000072, /* 00000072 //C 0f731  1915 db	114 */
0x0000f732, 0x00000073, /* 00000073 //C 0f732  1915 db	115 */
0x0000f733, 0x0000000a, /* 0000000a //C 0f733  1915 db	10 */
0x0000f734, 0x00000000, /* 00000000 //C 0f734  1915 db */
0x0000f735, 0x00000072, /* 00000072 //C 0f735  1916 db	114 */
0x0000f736, 0x00000058, /* 00000058 //C 0f736  1916 db	88 */
0x0000f737, 0x00000020, /* 00000020 //C 0f737  1916 db	32 */
0x0000f738, 0x0000005b, /* 0000005b //C 0f738  1916 db	91 */
0x0000f739, 0x00000076, /* 00000076 //C 0f739  1916 db	118 */
0x0000f73a, 0x00000061, /* 00000061 //C 0f73a  1916 db	97 */
0x0000f73b, 0x0000006c, /* 0000006c //C 0f73b  1916 db	108 */
0x0000f73c, 0x0000005d, /* 0000005d //C 0f73c  1916 db	93 */
0x0000f73d, 0x00000020, /* 00000020 //C 0f73d  1916 db	32 */
0x0000f73e, 0x00000020, /* 00000020 //C 0f73e  1916 db	32 */
0x0000f73f, 0x00000020, /* 00000020 //C 0f73f  1916 db	32 */
0x0000f740, 0x00000020, /* 00000020 //C 0f740  1916 db	32 */
0x0000f741, 0x00000020, /* 00000020 //C 0f741  1916 db	32 */
0x0000f742, 0x00000020, /* 00000020 //C 0f742  1916 db	32 */
0x0000f743, 0x00000020, /* 00000020 //C 0f743  1916 db	32 */
0x0000f744, 0x00000020, /* 00000020 //C 0f744  1916 db	32 */
0x0000f745, 0x00000020, /* 00000020 //C 0f745  1916 db	32 */
0x0000f746, 0x00000020, /* 00000020 //C 0f746  1916 db	32 */
0x0000f747, 0x00000047, /* 00000047 //C 0f747  1916 db	71 */
0x0000f748, 0x00000065, /* 00000065 //C 0f748  1916 db	101 */
0x0000f749, 0x00000074, /* 00000074 //C 0f749  1916 db	116 */
0x0000f74a, 0x0000002f, /* 0000002f //C 0f74a  1916 db	47 */
0x0000f74b, 0x00000073, /* 00000073 //C 0f74b  1916 db	115 */
0x0000f74c, 0x00000065, /* 00000065 //C 0f74c  1916 db	101 */
0x0000f74d, 0x00000074, /* 00000074 //C 0f74d  1916 db	116 */
0x0000f74e, 0x00000020, /* 00000020 //C 0f74e  1916 db	32 */
0x0000f74f, 0x00000052, /* 00000052 //C 0f74f  1916 db	82 */
0x0000f750, 0x00000058, /* 00000058 //C 0f750  1916 db	88 */
0x0000f751, 0x0000000a, /* 0000000a //C 0f751  1916 db	10 */
0x0000f752, 0x00000000, /* 00000000 //C 0f752  1916 db */
0x0000f753, 0x00000073, /* 00000073 //C 0f753  1917 db	115 */
0x0000f754, 0x00000070, /* 00000070 //C 0f754  1917 db	112 */
0x0000f755, 0x00000020, /* 00000020 //C 0f755  1917 db	32 */
0x0000f756, 0x0000005b, /* 0000005b //C 0f756  1917 db	91 */
0x0000f757, 0x00000076, /* 00000076 //C 0f757  1917 db	118 */
0x0000f758, 0x00000061, /* 00000061 //C 0f758  1917 db	97 */
0x0000f759, 0x0000006c, /* 0000006c //C 0f759  1917 db	108 */
0x0000f75a, 0x0000005d, /* 0000005d //C 0f75a  1917 db	93 */
0x0000f75b, 0x00000020, /* 00000020 //C 0f75b  1917 db	32 */
0x0000f75c, 0x00000020, /* 00000020 //C 0f75c  1917 db	32 */
0x0000f75d, 0x00000020, /* 00000020 //C 0f75d  1917 db	32 */
0x0000f75e, 0x00000020, /* 00000020 //C 0f75e  1917 db	32 */
0x0000f75f, 0x00000020, /* 00000020 //C 0f75f  1917 db	32 */
0x0000f760, 0x00000020, /* 00000020 //C 0f760  1917 db	32 */
0x0000f761, 0x00000020, /* 00000020 //C 0f761  1917 db	32 */
0x0000f762, 0x00000020, /* 00000020 //C 0f762  1917 db	32 */
0x0000f763, 0x00000020, /* 00000020 //C 0f763  1917 db	32 */
0x0000f764, 0x00000020, /* 00000020 //C 0f764  1917 db	32 */
0x0000f765, 0x00000047, /* 00000047 //C 0f765  1917 db	71 */
0x0000f766, 0x00000065, /* 00000065 //C 0f766  1917 db	101 */
0x0000f767, 0x00000074, /* 00000074 //C 0f767  1917 db	116 */
0x0000f768, 0x0000002f, /* 0000002f //C 0f768  1917 db	47 */
0x0000f769, 0x00000073, /* 00000073 //C 0f769  1917 db	115 */
0x0000f76a, 0x00000065, /* 00000065 //C 0f76a  1917 db	101 */
0x0000f76b, 0x00000074, /* 00000074 //C 0f76b  1917 db	116 */
0x0000f76c, 0x00000020, /* 00000020 //C 0f76c  1917 db	32 */
0x0000f76d, 0x00000052, /* 00000052 //C 0f76d  1917 db	82 */
0x0000f76e, 0x00000031, /* 00000031 //C 0f76e  1917 db	49 */
0x0000f76f, 0x00000033, /* 00000033 //C 0f76f  1917 db	51 */
0x0000f770, 0x0000000a, /* 0000000a //C 0f770  1917 db	10 */
0x0000f771, 0x00000000, /* 00000000 //C 0f771  1917 db */
0x0000f772, 0x0000006c, /* 0000006c //C 0f772  1918 db	108 */
0x0000f773, 0x00000072, /* 00000072 //C 0f773  1918 db	114 */
0x0000f774, 0x00000020, /* 00000020 //C 0f774  1918 db	32 */
0x0000f775, 0x0000005b, /* 0000005b //C 0f775  1918 db	91 */
0x0000f776, 0x00000076, /* 00000076 //C 0f776  1918 db	118 */
0x0000f777, 0x00000061, /* 00000061 //C 0f777  1918 db	97 */
0x0000f778, 0x0000006c, /* 0000006c //C 0f778  1918 db	108 */
0x0000f779, 0x0000005d, /* 0000005d //C 0f779  1918 db	93 */
0x0000f77a, 0x00000020, /* 00000020 //C 0f77a  1918 db	32 */
0x0000f77b, 0x00000020, /* 00000020 //C 0f77b  1918 db	32 */
0x0000f77c, 0x00000020, /* 00000020 //C 0f77c  1918 db	32 */
0x0000f77d, 0x00000020, /* 00000020 //C 0f77d  1918 db	32 */
0x0000f77e, 0x00000020, /* 00000020 //C 0f77e  1918 db	32 */
0x0000f77f, 0x00000020, /* 00000020 //C 0f77f  1918 db	32 */
0x0000f780, 0x00000020, /* 00000020 //C 0f780  1918 db	32 */
0x0000f781, 0x00000020, /* 00000020 //C 0f781  1918 db	32 */
0x0000f782, 0x00000020, /* 00000020 //C 0f782  1918 db	32 */
0x0000f783, 0x00000020, /* 00000020 //C 0f783  1918 db	32 */
0x0000f784, 0x00000047, /* 00000047 //C 0f784  1918 db	71 */
0x0000f785, 0x00000065, /* 00000065 //C 0f785  1918 db	101 */
0x0000f786, 0x00000074, /* 00000074 //C 0f786  1918 db	116 */
0x0000f787, 0x0000002f, /* 0000002f //C 0f787  1918 db	47 */
0x0000f788, 0x00000073, /* 00000073 //C 0f788  1918 db	115 */
0x0000f789, 0x00000065, /* 00000065 //C 0f789  1918 db	101 */
0x0000f78a, 0x00000074, /* 00000074 //C 0f78a  1918 db	116 */
0x0000f78b, 0x00000020, /* 00000020 //C 0f78b  1918 db	32 */
0x0000f78c, 0x00000052, /* 00000052 //C 0f78c  1918 db	82 */
0x0000f78d, 0x00000031, /* 00000031 //C 0f78d  1918 db	49 */
0x0000f78e, 0x00000034, /* 00000034 //C 0f78e  1918 db	52 */
0x0000f78f, 0x0000000a, /* 0000000a //C 0f78f  1918 db	10 */
0x0000f790, 0x00000000, /* 00000000 //C 0f790  1918 db */
0x0000f791, 0x00000070, /* 00000070 //C 0f791  1919 db	112 */
0x0000f792, 0x00000063, /* 00000063 //C 0f792  1919 db	99 */
0x0000f793, 0x00000020, /* 00000020 //C 0f793  1919 db	32 */
0x0000f794, 0x0000005b, /* 0000005b //C 0f794  1919 db	91 */
0x0000f795, 0x00000076, /* 00000076 //C 0f795  1919 db	118 */
0x0000f796, 0x00000061, /* 00000061 //C 0f796  1919 db	97 */
0x0000f797, 0x0000006c, /* 0000006c //C 0f797  1919 db	108 */
0x0000f798, 0x0000005d, /* 0000005d //C 0f798  1919 db	93 */
0x0000f799, 0x00000020, /* 00000020 //C 0f799  1919 db	32 */
0x0000f79a, 0x00000020, /* 00000020 //C 0f79a  1919 db	32 */
0x0000f79b, 0x00000020, /* 00000020 //C 0f79b  1919 db	32 */
0x0000f79c, 0x00000020, /* 00000020 //C 0f79c  1919 db	32 */
0x0000f79d, 0x00000020, /* 00000020 //C 0f79d  1919 db	32 */
0x0000f79e, 0x00000020, /* 00000020 //C 0f79e  1919 db	32 */
0x0000f79f, 0x00000020, /* 00000020 //C 0f79f  1919 db	32 */
0x0000f7a0, 0x00000020, /* 00000020 //C 0f7a0  1919 db	32 */
0x0000f7a1, 0x00000020, /* 00000020 //C 0f7a1  1919 db	32 */
0x0000f7a2, 0x00000020, /* 00000020 //C 0f7a2  1919 db	32 */
0x0000f7a3, 0x00000047, /* 00000047 //C 0f7a3  1919 db	71 */
0x0000f7a4, 0x00000065, /* 00000065 //C 0f7a4  1919 db	101 */
0x0000f7a5, 0x00000074, /* 00000074 //C 0f7a5  1919 db	116 */
0x0000f7a6, 0x0000002f, /* 0000002f //C 0f7a6  1919 db	47 */
0x0000f7a7, 0x00000073, /* 00000073 //C 0f7a7  1919 db	115 */
0x0000f7a8, 0x00000065, /* 00000065 //C 0f7a8  1919 db	101 */
0x0000f7a9, 0x00000074, /* 00000074 //C 0f7a9  1919 db	116 */
0x0000f7aa, 0x00000020, /* 00000020 //C 0f7aa  1919 db	32 */
0x0000f7ab, 0x00000052, /* 00000052 //C 0f7ab  1919 db	82 */
0x0000f7ac, 0x00000031, /* 00000031 //C 0f7ac  1919 db	49 */
0x0000f7ad, 0x00000035, /* 00000035 //C 0f7ad  1919 db	53 */
0x0000f7ae, 0x0000000a, /* 0000000a //C 0f7ae  1919 db	10 */
0x0000f7af, 0x00000000, /* 00000000 //C 0f7af  1919 db */
0x0000f7b0, 0x00000066, /* 00000066 //C 0f7b0  1920 db	102 */
0x0000f7b1, 0x00000020, /* 00000020 //C 0f7b1  1920 db	32 */
0x0000f7b2, 0x0000005b, /* 0000005b //C 0f7b2  1920 db	91 */
0x0000f7b3, 0x00000076, /* 00000076 //C 0f7b3  1920 db	118 */
0x0000f7b4, 0x00000061, /* 00000061 //C 0f7b4  1920 db	97 */
0x0000f7b5, 0x0000006c, /* 0000006c //C 0f7b5  1920 db	108 */
0x0000f7b6, 0x0000005d, /* 0000005d //C 0f7b6  1920 db	93 */
0x0000f7b7, 0x00000020, /* 00000020 //C 0f7b7  1920 db	32 */
0x0000f7b8, 0x00000020, /* 00000020 //C 0f7b8  1920 db	32 */
0x0000f7b9, 0x00000020, /* 00000020 //C 0f7b9  1920 db	32 */
0x0000f7ba, 0x00000020, /* 00000020 //C 0f7ba  1920 db	32 */
0x0000f7bb, 0x00000020, /* 00000020 //C 0f7bb  1920 db	32 */
0x0000f7bc, 0x00000020, /* 00000020 //C 0f7bc  1920 db	32 */
0x0000f7bd, 0x00000020, /* 00000020 //C 0f7bd  1920 db	32 */
0x0000f7be, 0x00000020, /* 00000020 //C 0f7be  1920 db	32 */
0x0000f7bf, 0x00000020, /* 00000020 //C 0f7bf  1920 db	32 */
0x0000f7c0, 0x00000020, /* 00000020 //C 0f7c0  1920 db	32 */
0x0000f7c1, 0x00000020, /* 00000020 //C 0f7c1  1920 db	32 */
0x0000f7c2, 0x00000047, /* 00000047 //C 0f7c2  1920 db	71 */
0x0000f7c3, 0x00000065, /* 00000065 //C 0f7c3  1920 db	101 */
0x0000f7c4, 0x00000074, /* 00000074 //C 0f7c4  1920 db	116 */
0x0000f7c5, 0x0000002f, /* 0000002f //C 0f7c5  1920 db	47 */
0x0000f7c6, 0x00000073, /* 00000073 //C 0f7c6  1920 db	115 */
0x0000f7c7, 0x00000065, /* 00000065 //C 0f7c7  1920 db	101 */
0x0000f7c8, 0x00000074, /* 00000074 //C 0f7c8  1920 db	116 */
0x0000f7c9, 0x00000020, /* 00000020 //C 0f7c9  1920 db	32 */
0x0000f7ca, 0x00000066, /* 00000066 //C 0f7ca  1920 db	102 */
0x0000f7cb, 0x0000006c, /* 0000006c //C 0f7cb  1920 db	108 */
0x0000f7cc, 0x00000061, /* 00000061 //C 0f7cc  1920 db	97 */
0x0000f7cd, 0x00000067, /* 00000067 //C 0f7cd  1920 db	103 */
0x0000f7ce, 0x00000073, /* 00000073 //C 0f7ce  1920 db	115 */
0x0000f7cf, 0x0000000a, /* 0000000a //C 0f7cf  1920 db	10 */
0x0000f7d0, 0x00000000, /* 00000000 //C 0f7d0  1920 db */
0x0000f7d1, 0x00000068, /* 00000068 //C 0f7d1  1921 db	104 */
0x0000f7d2, 0x0000005b, /* 0000005b //C 0f7d2  1921 db	91 */
0x0000f7d3, 0x00000065, /* 00000065 //C 0f7d3  1921 db	101 */
0x0000f7d4, 0x0000006c, /* 0000006c //C 0f7d4  1921 db	108 */
0x0000f7d5, 0x00000070, /* 00000070 //C 0f7d5  1921 db	112 */
0x0000f7d6, 0x0000005d, /* 0000005d //C 0f7d6  1921 db	93 */
0x0000f7d7, 0x0000002c, /* 0000002c //C 0f7d7  1921 db	44 */
0x0000f7d8, 0x0000003f, /* 0000003f //C 0f7d8  1921 db	63 */
0x0000f7d9, 0x00000020, /* 00000020 //C 0f7d9  1921 db	32 */
0x0000f7da, 0x00000020, /* 00000020 //C 0f7da  1921 db	32 */
0x0000f7db, 0x00000020, /* 00000020 //C 0f7db  1921 db	32 */
0x0000f7dc, 0x00000020, /* 00000020 //C 0f7dc  1921 db	32 */
0x0000f7dd, 0x00000020, /* 00000020 //C 0f7dd  1921 db	32 */
0x0000f7de, 0x00000020, /* 00000020 //C 0f7de  1921 db	32 */
0x0000f7df, 0x00000020, /* 00000020 //C 0f7df  1921 db	32 */
0x0000f7e0, 0x00000020, /* 00000020 //C 0f7e0  1921 db	32 */
0x0000f7e1, 0x00000020, /* 00000020 //C 0f7e1  1921 db	32 */
0x0000f7e2, 0x00000020, /* 00000020 //C 0f7e2  1921 db	32 */
0x0000f7e3, 0x00000048, /* 00000048 //C 0f7e3  1921 db	72 */
0x0000f7e4, 0x00000065, /* 00000065 //C 0f7e4  1921 db	101 */
0x0000f7e5, 0x0000006c, /* 0000006c //C 0f7e5  1921 db	108 */
0x0000f7e6, 0x00000070, /* 00000070 //C 0f7e6  1921 db	112 */
0x0000f7e7, 0x0000000a, /* 0000000a //C 0f7e7  1921 db	10 */
0x0000f7e8, 0x00000000, /* 00000000 //C 0f7e8  1921 db */
0x0000f7e9, 0x00000000, /* 00000000 //C 0f7e9  1922 dd	0 */
0x0000f7ea, 0x00000000, /* 00000000 //C 0f7ea  1928 ds	0x40 */
0x0000f82a, 0x00000000, /* 00000000 //C 0f82a  1930 ds	1 */
0x0000f82b, 0x00000000, /* 00000000 //C 0f82b     3  */
