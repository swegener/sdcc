...
struct dis_entry disass_stm8[]= {
  ...
  { 0x00cd, 0x00ff, 's', 3, "call %x", true },
  { 0x00dd, 0x00ff, ' ', 3, "call (%2,X)", true },
  { 0x00ed, 0x00ff, ' ', 2, "call (%1,X)", true },
  { 0x00fd, 0x00ff, ' ', 1, "call (X)", true },
  { 0x008d, 0x00ff, 's', 4, "callf %e", true },
  { 0x00ad, 0x00ff, 's', 2, "callr %p", true },
  ...
  { 0x0080, 0x00ff, 'x', 1, "iret" },

  { 0x00cc, 0x00ff, 'j', 3, "jp %x" },
  { 0x00dc, 0x00ff, 'x', 3, "jp (%2,X)" },
  { 0x00ec, 0x00ff, 'x', 2, "jp (%1,X)" },
  { 0x00fc, 0x00ff, 'x', 1, "jp (X)" },
  ...
  { 0x0098, 0x00ff, ' ', 1, "rcf" },
  { 0x0081, 0x00ff, 'x', 1, "ret" },
  { 0x0087, 0x00ff, 'x', 1, "retf" },
  { 0x009a, 0x00ff, ' ', 1, "rim" },
...
struct dis_entry disass_stm8_72[]= {
  ...
  { 0x00cc, 0x00ff, 'x', 3, "jp [%2.w]" },
  { 0x00dc, 0x00ff, 'x', 3, "jp ([%2.w],X)" },
...
struct dis_entry disass_stm8_90[]= {
  ...
  // 90
  { 0x00dc, 0x00ff, 'x', 3, "jp (%2,Y)" },
  { 0x00ec, 0x00ff, 'x', 2, "jp (%1,Y)" },
  { 0x00fc, 0x00ff, 'x', 1, "jp (Y)" },
  // 90
...
struct dis_entry disass_stm8_92[]= {
  ...
  { 0x00cc, 0x00ff, 'x', 2, "jp [%1.w]" },
  { 0x00dc, 0x00ff, 'x', 2, "jp ([%1.w],X)" },
  { 0x00ac, 0x00ff, 'x', 3, "jpf [%2.e]" },
