...
# output, the main test's Makefile, test-lib.mk and the simulator being
# tested. Other dependencies and the recipe used for the test are in the
# main test's Makefile.
