...
cl_z80::inst_Xd_ld(t_mem code)
{
  ...
  switch (code) {
    ...
    case 0x56: // LD D,(IX+dd)
      ...
      tick(18);
      return(resGO);
    case 0x5C: // LD E,H   E,HX?
      regs.de.l = regs_iX_h;//regs.hl.h;
      return(resGO);
    case 0x5D: // LD E,L   E,LX?
      regs.de.l = regs_iX_l;//regs.hl.l;
      return(resGO);
...
cl_z80::inst_Xd(t_mem prefix)
{
  ...
  switch (prefix)
    {
    case 0xdd:
      return inst_dd_spec(code);
    case 0xfd:
      return inst_fd_spec(code);
    }
