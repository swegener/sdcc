/*
   bug-3229.c
   A crash in code generation for stm8 in the modular inversion of the NTRU reference implementation.
 */
...
#define NTRU_N 67 // Smallest prime for which the bug could be reproduced.
